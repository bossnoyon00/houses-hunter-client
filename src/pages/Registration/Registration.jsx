...
const Registration = () => {
  ...
  const onSubmit = (data) => {
    ...
    // register a user
    axios
      .post(`https://house-hunter-server-mu.vercel.app/users`, { ...data })
      .then((res) => {
  ...
  return (
    ...
    <div className="flex">
      <div
        ...
        style={{
          background: `url(https://img.freepik.com/free-vector/privacy-policy-concept-illustration_114360-7853.jpg?w=740&t=st=1689765615~exp=1689766215~hmac=10a9584ff46b5ebf1e5df21984a2973c593dd8487994501a289e47fae1807659)`,
